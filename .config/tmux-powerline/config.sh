...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="vypxl"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/thomas/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/thomas"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/thomas/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/thomas/.now_playing.log"
...
# tmux_session_info.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_SESSION_INFO_FORMAT="#S | #T"
# }
